...
def test_load_orm_from_dict() -> None:
    rl = {
        "property_id": "123",
        "image_url": "https://media.rightmove.co.uk/dir/crop/10:9-16:9/260k/259202/144595010"
    ...
    assert rl2.image_url == "https://media.rightmove.co.uk/dir/crop/10:9-16:9/260k/259202/144595010" \
                             "/259202_THECI_005196_IMG_00_0000_max_476x317.jpeg"
    ...
    assert rl2.added_date == datetime.datetime(2024, 2, 10)
    assert rl2.address == "123 Fake Street, N1 1AA"
    assert rl2.postcode == "N1 1AA"
    assert rl2.created_date == datetime.datetime(2024, 1, 10)
