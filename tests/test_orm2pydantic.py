...
def test_load_orm_from_dict(rental_listing):
    ...
    assert rental_listing.image_url == "https://media.rightmove.co.uk/dir/crop/10:9-16:9/260k/259202/144595010/259202_THECI_005196_IMG_00_0000_max_476x317.jpeg"
...
def test_load_pydantic_from_orm(rental_listing) -> None:
    ...
    assert pyd.price == Price(price=1000, currency=Currency.GBP, per=PriceUnit.PER_MONTH)
