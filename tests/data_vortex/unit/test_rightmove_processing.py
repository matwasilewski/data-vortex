...
def test_get_detailed_listing(rightmove_listing_sample: BeautifulSoup):
    ...
    assert listing.description == ("2 bedroom apartment for rent in Sycamore Street, London, EC1Y 0SR, UK, EC1Y for "
                                   "£3,370 pcm. Marketed by BLUEGROUND FURNISHED APARTMENTS UK LTD, London")
